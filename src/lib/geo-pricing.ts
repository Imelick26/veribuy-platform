 ...
 *
 * 1. ZIP → State mapping (first 3 digits of ZIP = state)
 * 2. Regional pricing multipliers by vehicle category
 *
 * Regional multipliers reflect real market differences:
 *   - Trucks/4WD worth MORE in rural, mountain, and southern states
 *   - Sedans/EVs worth MORE in urban coastal states
 *   - SUVs are relatively flat nationally
 */
...
const ZIP_PREFIX_TO_STATE: Record<string, string> = {
  ...
  // Vermont
  "050": "VT", "051": "VT", "052": "VT", "053": "VT", "054": "VT", "056": "VT", "057": "VT",
  "058": "VT", "059": "VT",
  // New Jersey
  ...
  "114": "NY", "115": "NY", "116": "NY", "117": "NY", "118": "NY", "119": "NY",
  "120": "NY", "121": "NY", "122": "NY", "123": "NY", "124": "NY", "125": "NY", "126": "NY",
  "127": "NY", "128": "NY", "129": "NY", "130": "NY", "131": "NY", "132": "NY", "133": "NY",
  "134": "NY", "135": "NY", "136": "NY", "137": "NY", "138": "NY", "139": "NY", "140": "NY",
  "141": "NY", "142": "NY", "143": "NY", "144": "NY", "145": "NY", "146": "NY", "147": "NY",
  "148": "NY", "149": "NY",
  // Pennsylvania
  "150": "PA", "151": "PA", "152": "PA", "153": "PA", "154": "PA", "155": "PA", "156": "PA",
  "157": "PA", "158": "PA", "159": "PA", "160": "PA", "161": "PA", "162": "PA", "163": "PA",
  "164": "PA", "165": "PA", "166": "PA", "167": "PA", "168": "PA", "169": "PA",
  "170": "PA", "171": "PA", "172": "PA", "173": "PA", "174": "PA", "175": "PA", "176": "PA",
  "177": "PA", "178": "PA", "179": "PA", "180": "PA", "181": "PA", "182": "PA", "183": "PA",
  "184": "PA", "185": "PA", "186": "PA", "187": "PA", "188": "PA", "189": "PA", "190": "PA",
  ...
  // Virginia
  "220": "VA", "221": "VA", "222": "VA", "223": "VA", "224": "VA", "225": "VA", "226": "VA",
  "227": "VA", "228": "VA", "229": "VA", "230": "VA", "231": "VA", "232": "VA", "233": "VA",
  "234": "VA", "235": "VA", "236": "VA", "237": "VA", "238": "VA", "239": "VA", "240": "VA",
  "241": "VA", "242": "VA", "243": "VA", "244": "VA", "245": "VA", "246": "VA",
  // West Virginia
  ...
  "213": "MD", "214": "MD", "215": "MD", "216": "MD", "217": "MD", "218": "MD", "219": "MD",
  // North Carolina
  ...
  "334": "FL", "335": "FL", "336": "FL", "337": "FL", "338": "FL", "339": "FL",
  ...
  "507": "IA", "508": "IA", "509": "IA", "510": "IA", "511": "IA", "512": "IA", "513": "IA",
  "514": "IA", "515": "IA", "516": "IA",
  // Wisconsin
  ...
  "622": "IL", "623": "IL", "624": "IL", "625": "IL", "626": "IL", "627": "IL", "628": "IL",
  "629": "IL",
  // Missouri
  ...
  // Oklahoma
  "730": "OK", "731": "OK", "734": "OK", "735": "OK", "736": "OK", "737": "OK", "738": "OK",
  "739": "OK", "740": "OK", "741": "OK", "743": "OK", "744": "OK", "745": "OK", "746": "OK",
  ...
  "937": "CA", "938": "CA", "939": "CA", "940": "CA", "941": "CA", "943": "CA", "944": "CA",
  "945": "CA", "946": "CA", "947": "CA", "948": "CA", "949": "CA", "950": "CA", "951": "CA",
  "952": "CA", "953": "CA", "954": "CA", "955": "CA", "956": "CA", "957": "CA", "958": "CA",
...
/**
 * Derive state code from a ZIP code.
 * Returns 2-letter state code or "OR" as fallback.
 */
export function zipToState(zip: string): string {
  const prefix = zip.replace(/\D/g, "").substring(0, 3);
  return ZIP_PREFIX_TO_STATE[prefix] || "OR";
}
...
/**
 * Regional multiplier by state and vehicle category.
 *
 * Based on real market data patterns:
 *   - Trucks: +5-10% in TX, OK, rural mountain states; -5% in NE coastal
 *   - SUVs/4WD: +5-8% in CO, UT, MT, WY (mountain/snow states)
 *   - Sedans: +3-5% in CA, NY, urban areas; -3-5% in rural
 *   - Sports: +5% in CA, FL, AZ (warm weather)
 *   - EVs: +5-8% in CA, WA, OR (green incentive states)
 *
 * Returns multiplier (1.0 = national average)
 */
export function getRegionalMultiplier(
  state: string,
  bodyCategory: string,
): number {
  const multipliers = REGIONAL_MULTIPLIERS[bodyCategory] || REGIONAL_MULTIPLIERS.other;
  return multipliers[state] || 1.0;
}

const TRUCK_PREMIUM_STATES: Record<string, number> = {
  TX: 1.08, OK: 1.06, AR: 1.05, LA: 1.04, MS: 1.04,
  AL: 1.04, TN: 1.04, KY: 1.03, WV: 1.03,
  MT: 1.06, WY: 1.06, ID: 1.05, SD: 1.04, ND: 1.04, NE: 1.03,
  CO: 1.05, UT: 1.04, NM: 1.03, AZ: 1.02,
  // Discount in dense urban / NE coastal
  NY: 0.96, NJ: 0.96, CT: 0.95, MA: 0.96, RI: 0.95,
  DC: 0.93, MD: 0.97,
  // CA is mixed — trucks popular in Central Valley, not in LA/SF
  CA: 0.98,
};

const SUV_PREMIUM_STATES: Record<string, number> = {
  CO: 1.06, UT: 1.05, MT: 1.05, WY: 1.05, ID: 1.04,
  MN: 1.03, WI: 1.03, MI: 1.02,
  NH: 1.03, VT: 1.03, ME: 1.03, // snow states
  FL: 0.98, HI: 0.97, // less demand for AWD
};

const SEDAN_PREMIUM_STATES: Record<string, number> = {
  CA: 1.04, NY: 1.03, NJ: 1.02, MA: 1.02, CT: 1.02, DC: 1.03,
  FL: 1.02, IL: 1.02, WA: 1.02,
  // Discount in truck country
  TX: 0.97, OK: 0.96, MT: 0.95, WY: 0.95,
};

const SPORTS_PREMIUM_STATES: Record<string, number> = {
  CA: 1.05, FL: 1.05, AZ: 1.04, NV: 1.03, TX: 1.03,
  HI: 1.03, SC: 1.02, GA: 1.02,
  // Discount in harsh winter states
  MN: 0.96, WI: 0.96, ND: 0.95, MT: 0.95, ME: 0.96,
};

const REGIONAL_MULTIPLIERS: Record<string, Record<string, number>> = {
  truck: TRUCK_PREMIUM_STATES,
  suv: SUV_PREMIUM_STATES,
  sedan: SEDAN_PREMIUM_STATES,
  sports: SPORTS_PREMIUM_STATES,
  other: {}, // 1.0 everywhere for uncategorized
};
