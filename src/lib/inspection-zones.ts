...
const SEDAN_ZONES: InspectionZone[] = [
  ...
  },
  {
    ...
    subPositions: {
      ...
      // Extended sub-positions for AI-generated componentHints
      hpop: [0, 0.28, 0.75],
      water_pump: [0.15, 0.3, 0.95],
      timing: [0.2, 0.32, 0.9],
      valve_cover: [0, 0.45, 0.8],
      intake: [0, 0.45, 0.85],
      serpentine: [-0.3, 0.35, 0.85],
      oil_pan: [0, 0.12, 0.7],
      head_gasket: [0, 0.4, 0.8],
      throttle_body: [0.15, 0.42, 0.9],
      egr: [-0.2, 0.38, 0.75],
      pcv: [0.1, 0.42, 0.78],
    },
    cameraPreset: "front",
  },
  {
    ...
    subPositions: {
      ...
      // Extended
      transfer_case: [0, 0.1, 0.1],
      u_joint: [0, 0.08, -0.3],
      torque_converter: [0, 0.12, 0.35],
      valve_body: [0, 0.1, 0.25],
      steering_rack: [0, 0.12, 0.85],
      steering_column: [0, 0.45, 0.5],
      power_steering: [-0.2, 0.18, 0.8],
    },
  ...
  },
  {
    ...
    subPositions: {
      ...
      shock: [0.5, 0.22, -0.7],
      // Extended
      ball_joint: [0.52, 0.06, 0.68],
      tie_rod: [0.4, 0.1, 0.75],
      wheel_bearing: [0.56, 0.12, 0.7],
      leaf_spring: [0.45, 0.1, -0.7],
      torsion_bar: [0.35, 0.08, 0.5],
      bushing: [0.48, 0.1, 0.6],
      coil_spring: [0.5, 0.2, 0.7],
    },
    cameraPreset: "driver",
  },
  {
  ...
  },
  {
    ...
    category: "STRUCTURAL",
    boundingBox: { min: [-0.55, 0, -1.2], max: [0.55, 0.15, 1.2] },
    markerPosition: [0.35, 0.05, 0],
    subPositions: {
      default: [0.35, 0.05, 0],
      frame_front: [0.3, 0.05, 0.7],
      frame_mid: [0.3, 0.05, 0],
      frame_rear: [0.3, 0.05, -0.7],
      subframe: [0, 0.08, 0.5],
      rocker_panel: [0.55, 0.12, 0],
      crossmember: [0, 0.06, 0.3],
      floor_pan: [0, 0.05, -0.1],
      unibody: [0.3, 0.08, 0],
    },
    cameraPreset: "driver",
  },
  {
    ...
    boundingBox: { min: [-0.3, 0, 0.1], max: [0.3, 0.2, 0.5] },
    markerPosition: [0, 0.12, 0.3],
    subPositions: {
      default: [0, 0.12, 0.3],
      transmission: [0, 0.12, 0.3],
      torque_converter: [0, 0.12, 0.4],
      valve_body: [0, 0.1, 0.25],
      trans_pan: [0, 0.05, 0.25],
      trans_cooler: [0.2, 0.2, 0.3],
      shift_linkage: [0.15, 0.15, 0.3],
    },
    cameraPreset: "overview",
  },
  {
    ...
    category: "SAFETY",
    boundingBox: { min: [-0.5, 0.3, -0.3], max: [0.5, 0.7, 0.5] },
    markerPosition: [0, 0.55, 0.3],
    subPositions: {
      default: [0, 0.55, 0.3],
      airbag: [0, 0.52, 0.4],
      seatbelt: [0.35, 0.45, 0.1],
      sensor_front: [0, 0.35, 1.2],
      sensor_rear: [0, 0.35, -1.2],
      camera: [0, 0.72, -0.35],
    },
    cameraPreset: "overview",
  },
  {
    ...
    boundingBox: { min: [-0.4, 0.35, -0.1], max: [0.4, 0.65, 0.5] },
    markerPosition: [0, 0.5, 0.35],
    subPositions: {
      default: [0, 0.5, 0.35],
      infotainment: [0, 0.52, 0.35],
      cluster: [0, 0.5, 0.42],
      bcm: [-0.3, 0.42, 0.3],
      tcm: [0, 0.15, 0.3],
      ecm: [0.2, 0.38, 0.8],
  ...
  },
  {
    ...
    label: "HVAC",
    category: "HVAC",
    boundingBox: { min: [-0.35, 0.3, 0.2], max: [0.35, 0.55, 0.6] },
    markerPosition: [0, 0.42, 0.45],
    subPositions: {
      default: [0, 0.42, 0.45],
      compressor: [-0.3, 0.25, 0.75],
      condenser: [0, 0.35, 1.1],
      evaporator: [0, 0.45, 0.4],
      heater_core: [0.15, 0.4, 0.45],
      blower_motor: [-0.2, 0.42, 0.35],
    },
    cameraPreset: "front",
  },
];
